...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BPInfo ERP" },
      { name: "description", content: "Registro rápido de atendimentos da loja" },
      { name: "theme-color", content: "#0a1e42" },
      { property: "og:title", content: "BPInfo ERP" },
      { property: "og:description", content: "Registro rápido de atendimentos da loja" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "BPInfo ERP" },
      { name: "twitter:description", content: "Registro rápido de atendimentos da loja" },
